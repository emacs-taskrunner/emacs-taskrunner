...
nested in the file hierarchy of the project. This means that something like a
~Makefile~ that is deep within the hierarchy of a project might not be
discovered. I am working on improving this aspect right now.
** Supported Systems
...
- [ ] Add shallow/deep support. Deep support will use ripgrep/ag/grep(whichever
  ...
  on their system which scan the project root.
